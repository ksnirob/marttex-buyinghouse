...
const cats = [
  { key: "knit",   name: "Knit & Jersey",   desc: "T-shirts, polos, sweats, loungewear and performance knitwear.",   items: [tshirt, knit, sweat, polo, hero, tshirt, sweat, polo, knit] },
  { key: "woven",  name: "Woven Shirts",    desc: "Casual, formal, oxford, flannel and technical wovens.",            items: [shirtBlue, woven, flannel, shirtBlue, flannel, woven, shirtBlue] },
  { key: "denim",  name: "Denim & Bottoms", desc: "Jeans, chinos, shorts, skirts and denim jackets.",                items: [jeans, denim, chino, jeans, chino, denim, jeans, chino] },
  { key: "outer",  name: "Outerwear",       desc: "Puffers, trenches, bombers and technical shell jackets.",          items: [puffer, trench, puffer, trench, puffer, trench] },
  { key: "kids",   name: "Kids & Babywear", desc: "Soft, safe, certified fabrics for infants and children.",          items: [kidsStripe, kids, baby, kidsStripe, baby, kids, baby] },
  { key: "fabric", name: "Fabric & Trims",  desc: "Cotton, blends, recycled fibres and accessory sourcing.",          items: [fabric, sourcing, fabric, sourcing, fabric] },
];
