  ...
  return (
    <SiteLayout>
      <PageHeader
        ...
        lead="Pick the bundle you need. Most brands work with us end-to-end — from a sketch to a stocked warehouse."
      />
      <section className="section-reveal container-x grid gap-6 py-24 md:grid-cols-2">
      ...
      <section className="section-reveal bg-secondary/40 py-24">
        <div className="container-x">
          ...
          <h2 className="mt-3 font-display text-4xl text-primary md:text-5xl">
            A predictable, six-step process.
          </h2>
          <ol className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              [
                "01",
                "Brief & quote",
                "Send tech pack, target FOB and quantity. Quote in 48 hours.",
              ],
